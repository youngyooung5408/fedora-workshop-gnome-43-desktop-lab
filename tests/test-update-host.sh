...
cmp -s \
  ...
  "$ROOT/versions/v1/v1.3/v1.3.3/profile/extensions/desktop-lab-v12@young/extension.js"
cmp -s \
  "$EXT_ROOT/bluetooth-battery@young/extension.js" \
  "$ROOT/versions/v1/v1.3/v1.3.3/profile/extensions/bluetooth-battery@young/extension.js"
