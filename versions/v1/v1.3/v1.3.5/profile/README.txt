...
- The v1.3.5 refinement places the non-interactive Activities replica under GNOME Shell's actual wallpaper actor rather than beside it in the workspace background layout. It follows the wallpaper's allocation with one shared scale, cannot change the first workspace's requested geometry, is excluded from drag target picking, and leaves Shell's window-to-workspace dragging available.
