...
require_text "aesthetic preference.md" "actual full-monitor wallpaper actor" "aesthetic preference records wallpaper-matched overview embedding"
require_text "aesthetic preference.md" "one shared scale factor on both axes" "aesthetic preference records v1.3.4 aspect-locked overview scaling"
require_text "aesthetic preference.md" "not beside it as another workspace-layout child" "aesthetic preference records v1.3.5 layout-neutral wallpaper embedding"
require_text "aesthetic preference.md" "exclude it from Shell drag picking" "aesthetic preference records v1.3.5 drag-safe overview embedding"
require_text "aesthetic preference.md" "cap watchlists at about 10 instruments" "aesthetic preference records v1.3.3 market limit"
require_text "aesthetic preference.md" "without a nested scrollbar" "aesthetic preference records v1.3.3 running-app behavior"
require_text "aesthetic preference.md" "dismiss on a click in a plain area" "aesthetic preference records v1.3.3 outside-click dismissal"
require_text "TASK.md" 'Version `v1.3.5`' "TASK.md records v1.3.5 as the current request"
require_text "TASK.md" 'Version `v1.3.4`' "TASK.md records v1.3.4 as the current request"
require_text "TASK.md" 'Version `v1.3.3`' "TASK.md records v1.3.3 as the current request"
...
require_text "task/v 1/v 1.3/v 1.3.3.md" "## version 1.3.3" "v1.3.3 task note exists"
require_text "task/v 1/v 1.3/v 1.3.3.md" "## Completed design" "v1.3.3 task note records the completed design"
require_text "task/v 1/v 1.3/v 1.3.4.md" "## version 1.3.4" "v1.3.4 task note exists"
require_text "task/v 1/v 1.3/v 1.3.4.md" "## Completed design" "v1.3.4 task note records the completed design"
require_text "task/v 1/v 1.3/v 1.3.4.md" "## Diagnosis" "v1.3.4 task note records the unequal-clone-scale diagnosis"
require_text "task/v 1/v 1.3/v 1.3.5.md" "## version 1.3.5" "v1.3.5 task note exists"
require_text "task/v 1/v 1.3/v 1.3.5.md" "## Completed design" "v1.3.5 task note records the completed design"
require_text "task/v 1/v 1.3/v 1.3.5.md" "## Diagnosis" "v1.3.5 task note records the background-layout diagnosis"
...
require_text "$tuned_v12_extension/extension.js" "background?._backgroundGroup" "v1.3.3 locates the active overview wallpaper group"
require_absent_text "$tuned_v12_extension/extension.js" "workspace?._background?._bin ?? null" "v1.3.3 avoids the overview work-area allocation"
...
require_text "$tuned_v12_extension/extension.js" "layout_manager: new Clutter.FixedLayout()" "v1.3.4 gives the overview replica a fixed-allocation frame"
require_text "$tuned_v12_extension/extension.js" "_syncOverviewWidgetCloneGeometry" "v1.3.4 resynchronizes aspect-preserving clone geometry"
require_text "$tuned_v12_extension/extension.js" "const scale = Math.min(" "v1.3.4 chooses one fitting overview scale"
require_text "$tuned_v12_extension/extension.js" "clone.set_size(sourceWidth, sourceHeight)" "v1.3.4 retains the clone's native monitor allocation"
require_text "$tuned_v12_extension/extension.js" "clone.set_scale(scale, scale)" "v1.3.4 applies the same overview scale on both axes"
require_text "$tuned_v12_extension/extension.js" "'notify::allocation'" "v1.3.4 follows overview wallpaper reallocation"
require_text "$tuned_v12_extension/extension.js" "background?._bgManager?.backgroundActor" "v1.3.5 locates the actual overview wallpaper actor"
require_text "$tuned_v12_extension/extension.js" "wallpaperActor.add_child(frame)" "v1.3.5 parents the replica under the wallpaper actor"
require_text "$tuned_v12_extension/extension.js" "frame.set_size(wallpaperWidth, wallpaperHeight)" "v1.3.5 follows the wallpaper actor allocation"
require_absent_text "$tuned_v12_extension/extension.js" "container.add_child(frame)" "v1.3.5 no longer adds a sibling to the overview background layout"
require_text "$tuned_v12_extension/extension.js" "Shell.util_set_hidden_from_pick(frame, true)" "v1.3.5 keeps the replica out of Shell drag picking"
require_text "$tuned_v12_extension/extension.js" "'window-drag-begin'" "v1.3.5 observes Shell window dragging"
require_text "$tuned_v12_extension/extension.js" "_cancelDockDrag" "v1.3.5 clears custom dock dragging before a window drag"
...
require_text "$tuned_v12_extension/extension.js" "MAX_MARKET_INSTRUMENTS = 10" "v1.3.3 caps the market watchlist at 10"
require_text "$tuned_v12_extension/extension.js" "MARKET_VISIBLE_ROWS = 6" "v1.3.3 bounds the visible market rows"
require_text "$tuned_v12_extension/extension.js" "desktop-lab-v12-market-rows-scroll" "v1.3.3 scrolls the bounded market list"
require_text "$tuned_v12_extension/extension.js" "Math.max(298, Math.min(365" "v1.3.3 makes the market panel 25 percent wider"
require_text "$tuned_v12_extension/extension.js" "Math.floor(marketWidth)" "v1.3.3 matches the chooser to the market width"
require_text "$tuned_v12_extension/extension.js" "Key needed" "v1.3.3 explains missing international prices"
require_text "$tuned_v12_extension/extension.js" "_dismissEditorsOutside" "v1.3.3 dismisses editors on an outside click"
...
require_text "$tuned_v12_extension/market_provider.py" "mis.twse.com.tw" "v1.3.3 uses official Taiwan latest-trade data"
require_text "$tuned_v12_extension/market_provider.py" 'f"{TWELVE_BASE}/price?' "v1.3.3 uses Twelve Data's latest-price endpoint"
...
require_absent_text "$tuned_v12_extension/extension.js" "overview-apps" "v1.3.3 does not restore the old grouped Show Applications action"
require_text "$tuned_v12_extension/extension.js" "_showApplications" "v1.3.3 restores compact Show Applications access"
require_text "$tuned_v12_extension/extension.js" "view-app-grid-symbolic" "v1.3.3 gives Show Applications a compact dock icon"
...
require_absent_text "$tuned_v12_extension/extension.js" "desktop-lab-v12-running-apps-scroll" "v1.3.3 removes nested running-app scrolling"
...
require_text "$tuned_v12_metadata" "v1.3.5" "desktop-lab-v12 metadata records v1.3.5"
require_text "$tuned_v12_metadata" "wallpaper-child Activities widgets" "desktop-lab-v12 metadata records v1.3.5 wallpaper embedding"
require_text "$tuned_v12_metadata" "workspace geometry and window dragging" "desktop-lab-v12 metadata records v1.3.5 layout and drag behavior"
require_text "$tuned_v12_metadata" "ten-instrument latest-price market board" "desktop-lab-v12 metadata records v1.3.3 market behavior"
require_text "$tuned_v12_metadata" "non-scrolling running apps" "desktop-lab-v12 metadata records v1.3.3 running apps"
...
require_text "$tuned_v12_stylesheet" "desktop-lab-v12-market-rows-scroll" "v1.3.3 styles the bounded market rows"
require_absent_text "$tuned_v12_stylesheet" "desktop-lab-v12-running-apps-scroll" "v1.3.3 removes running-app scroll styling"
...
version_v133="versions/v1/v1.3/v1.3.3"
version_v133_extension="$version_v133/profile/extensions/desktop-lab-v12@young"
require_file "$version_v133/apply-v1.3.3.sh"
require_file "$version_v133/Apply v1.3.3.desktop"
require_file "$version_v133/profile/gsettings-export.sh"
require_file "$version_v133/host-manifest.json"
validate_host_manifest "$version_v133/host-manifest.json"
require_text "$version_v133_extension/extension.js" "_backgroundGroup" "v1.3.3 launcher includes wallpaper-matched overview embedding"
require_text "$version_v133_extension/extension.js" "MAX_MARKET_INSTRUMENTS = 10" "v1.3.3 launcher includes the market limit"
require_text "$version_v133_extension/extension.js" "_showApplications" "v1.3.3 launcher includes Show Applications access"
require_text "$version_v133_extension/metadata.json" "v1.3.3" "v1.3.3 launcher retains its historical metadata"

version_v134="versions/v1/v1.3/v1.3.4"
version_v134_extension="$version_v134/profile/extensions/desktop-lab-v12@young"
require_file "$version_v134/apply-v1.3.4.sh"
require_file "$version_v134/Apply v1.3.4.desktop"
require_file "$version_v134/profile/gsettings-export.sh"
require_file "$version_v134/host-manifest.json"
validate_host_manifest "$version_v134/host-manifest.json"
require_text "$version_v134_extension/extension.js" "clone.set_scale(scale, scale)" "v1.3.4 launcher includes aspect-locked overview scaling"
require_text "$version_v134_extension/extension.js" "_showApplications" "v1.3.4 launcher preserves compact Show Applications access"
require_text "$version_v134_extension/metadata.json" "v1.3.4" "v1.3.4 launcher retains its historical metadata"

version_v135="versions/v1/v1.3/v1.3.5"
version_v135_extension="$version_v135/profile/extensions/desktop-lab-v12@young"
require_file "$version_v135/apply-v1.3.5.sh"
require_file "$version_v135/Apply v1.3.5.desktop"
require_file "$version_v135/profile/gsettings-export.sh"
require_file "$version_v135/host-manifest.json"
validate_host_manifest "$version_v135/host-manifest.json"
require_identical_files "$tuned_v12_extension/extension.js" "$version_v135_extension/extension.js" "v1.3.5 launcher snapshots the reviewed extension source"
require_identical_files "$tuned_v12_extension/market_provider.py" "$version_v135_extension/market_provider.py" "v1.3.5 launcher snapshots the reviewed market provider"
require_identical_files "$tuned_v12_stylesheet" "$version_v135_extension/stylesheet.css" "v1.3.5 launcher snapshots the reviewed extension stylesheet"
require_identical_files "$tuned_v12_metadata" "$version_v135_extension/metadata.json" "v1.3.5 launcher snapshots the reviewed extension metadata"
require_text "$version_v135_extension/extension.js" "wallpaperActor.add_child(frame)" "v1.3.5 launcher embeds the replica under the wallpaper actor"
require_text "$version_v135_extension/extension.js" "Shell.util_set_hidden_from_pick(frame, true)" "v1.3.5 launcher preserves window drag picking"
require_text "$version_v135_extension/metadata.json" "v1.3.5" "v1.3.5 launcher records its metadata"
