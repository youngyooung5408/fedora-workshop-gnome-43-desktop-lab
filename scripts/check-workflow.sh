...
require_text "$tuned_v12_metadata" "v1.3.3" "desktop-lab-v12 metadata records v1.3.3"
require_text "$tuned_v12_metadata" "wallpaper-matched Activities widgets" "desktop-lab-v12 metadata records v1.3.3 overview embedding"
...
require_identical_files "$tuned_v12_extension/extension.js" "$version_v133_extension/extension.js" "v1.3.3 launcher snapshots the reviewed extension source"
require_identical_files "$tuned_v12_extension/market_provider.py" "$version_v133_extension/market_provider.py" "v1.3.3 launcher snapshots the reviewed market provider"
require_identical_files "$tuned_v12_stylesheet" "$version_v133_extension/stylesheet.css" "v1.3.3 launcher snapshots the reviewed extension stylesheet"
require_identical_files "$tuned_v12_metadata" "$version_v133_extension/metadata.json" "v1.3.3 launcher snapshots the reviewed extension metadata"
