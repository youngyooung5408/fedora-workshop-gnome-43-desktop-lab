...
require_text "aesthetic preference.md" "Desktop clocks should stay very simple" "aesthetic preference records v1.2.5 clock preference"
require_text "aesthetic preference.md" "pointer-proximity wave magnification" "aesthetic preference records v1.2.5 dock wave preference"
require_text "aesthetic preference.md" "open intentionally on click" "aesthetic preference records v1.2.5 click-open folder preference"
require_text "aesthetic preference.md" "hide update-time or provider/API labels" "aesthetic preference records v1.2.5 market simplicity preference"
require_text "TASK.md" 'Version `v1.2.5`' "TASK.md records v1.2.5 as the current request"
require_text "task/v 1.2/v 1.2.5.md" "## version 1.2.5" "v1.2.5 task note exists"
...
require_text "$tuned_v12_metadata" "v1.2.5 refinement" "desktop-lab-v12 metadata records v1.2.5 refinement"
...
version_v125="versions/v1/v1.2/v1.2.5"
version_v125_extension="$version_v125/profile/extensions/desktop-lab-v12@young"
require_file "$version_v125/apply-v1.2.5.sh"
require_file "$version_v125/Apply v1.2.5.desktop"
require_file "$version_v125/profile/gsettings-export.sh"
require_text "$version_v125_extension/metadata.json" "v1.2.5 refinement" "v1.2.5 launcher snapshot includes v1.2.5 metadata"
require_text "$version_v125_extension/extension.js" "const CLOCK_REFRESH_MS = 250" "v1.2.5 launcher snapshot includes continuous clock refresh"
require_text "$version_v125_extension/extension.js" "_updateDockWave" "v1.2.5 launcher snapshot includes dock wave"
require_absent_text "$version_v125_extension/extension.js" "Yahoo Chart API" "v1.2.5 launcher snapshot omits visible Yahoo Chart API text"
