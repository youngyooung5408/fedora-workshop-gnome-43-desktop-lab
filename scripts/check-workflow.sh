...
require_text "aesthetic preference.md" "full-monitor wallpaper background group" "aesthetic preference records v1.3.3 wallpaper-matched overview embedding"
...
require_text "$tuned_v12_extension/extension.js" "workspace?._background?._backgroundGroup" "v1.3.3 locates the active overview wallpaper group"
...
require_text "$tuned_v12_metadata" "v1.3.4" "desktop-lab-v12 metadata records v1.3.4"
require_text "$tuned_v12_metadata" "aspect-locked Activities widgets" "desktop-lab-v12 metadata records v1.3.4 overview scaling"
...
require_identical_files "$tuned_v12_extension/extension.js" "$version_v134_extension/extension.js" "v1.3.4 launcher snapshots the reviewed extension source"
require_identical_files "$tuned_v12_extension/market_provider.py" "$version_v134_extension/market_provider.py" "v1.3.4 launcher snapshots the reviewed market provider"
require_identical_files "$tuned_v12_stylesheet" "$version_v134_extension/stylesheet.css" "v1.3.4 launcher snapshots the reviewed extension stylesheet"
require_identical_files "$tuned_v12_metadata" "$version_v134_extension/metadata.json" "v1.3.4 launcher snapshots the reviewed extension metadata"
