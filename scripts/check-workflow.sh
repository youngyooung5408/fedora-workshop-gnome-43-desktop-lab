...
require_text "$tuned_v12_extension/extension.js" "_setBackgroundWidgetsVisible(false)" "v1.3.1 fades widgets for Activities and app search"
...
require_absent_text "$tuned_v12_extension/extension.js" "workspace?._background?._bin" "v1.3.1 avoids private overview workspace actors"
...
require_text "$tuned_v12_metadata" "stable first-workspace background widgets" "desktop-lab-v12 metadata records v1.3.1 background stability"
require_text "$tuned_v12_metadata" "verified TWSE, TPEx, and Twelve Data instruments" "desktop-lab-v12 metadata records v1.3.1 providers"
require_text "$tuned_v12_metadata" "installed-app-aware dock group editor" "desktop-lab-v12 metadata records v1.3.1 dock editor"
