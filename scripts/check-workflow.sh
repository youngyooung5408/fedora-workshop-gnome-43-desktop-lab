...
require_text "aesthetic preference.md" "overview-scale fallback" "aesthetic preference records v1.2.7 overview-scale widget preference"
...
require_text "aesthetic preference.md" "subtle edge hint" "aesthetic preference records v1.2.7 hidden dock hint preference"
...
require_text "TASK.md" 'Version `v1.2.7`' "TASK.md records v1.2.7 as the current request"
require_text "task/v 1.2/v1.2.7.md" "## version 1.2.7" "v1.2.7 task note exists"
...
require_text "$tuned_settings" "gsettings set org.gnome.desktop.background color-shading-type \\'vertical\\'" "v1.2.7 background uses vertical marine shading"
require_text "$tuned_settings" "gsettings set org.gnome.desktop.background primary-color \\'#041D2F\\'" "v1.2.7 background primary color is marine blue"
require_text "$tuned_settings" "gsettings set org.gnome.desktop.background secondary-color \\'#0A5266\\'" "v1.2.7 background secondary color is marine blue"
...
require_text "$tuned_v12_extension/extension.js" "DOCK_HINT_WIDTH" "v1.2.7 dock defines a persistent edge hint"
...
require_text "$tuned_v12_extension/extension.js" "_dockHint" "v1.2.7 dock includes a visible hidden-edge hint"
require_text "$tuned_v12_extension/extension.js" "_drawDockHint" "v1.2.7 dock hint uses restrained particle-like drawing"
require_text "$tuned_v12_extension/extension.js" "duration: 340" "v1.2.7 dock reveal uses smoother timing"
...
require_text "$tuned_v12_extension/extension.js" "OVERVIEW_WIDGET_SCALE" "v1.2.7 defines overview-scale fallback for background widgets"
require_text "$tuned_v12_extension/extension.js" "_setOverviewWidgetMode" "v1.2.7 scales background widgets during overview"
require_text "$tuned_v12_extension/extension.js" "Main.overview.connect('showing'" "v1.2.7 listens for Activities overview show events"
...
require_text "$tuned_v12_metadata" "v1.2.7 refinement" "desktop-lab-v12 metadata records v1.2.7 refinement"
...
require_text "$tuned_v12_stylesheet" "desktop-lab-v12-dock-hint" "v1.2.7 stylesheet includes hidden dock edge hint"
...
require_text "$tuned_v12_stylesheet" "#041d2f" "v1.2.7 stylesheet uses dark marine base"
...
require_text "$tuned_v12_extension/extension.js" "0.015, 0.11, 0.18" "v1.2.7 rest screen drawing uses dark marine base"
require_absent_text "$tuned_v12_stylesheet" "background-color: #000000" "v1.2.7 stylesheet does not return to solid black surfaces"
