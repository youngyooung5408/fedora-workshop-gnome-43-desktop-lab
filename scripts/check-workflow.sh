...
require_text "TASK.md" 'Version `v1.2.8`' "TASK.md records v1.2.8 as the current request"
require_text "task/v 1.2/v 1.2.8.md" "## version 1.2.8" "v1.2.8 task note exists"
...
require_text "$tuned_v12_metadata" "v1.2.8 refinement" "desktop-lab-v12 metadata records v1.2.8 refinement"
